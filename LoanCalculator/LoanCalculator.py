...
class LoanCalculator():
    def __init__(self):
        ...
        btComputePayment = Button(window, text="Compute Payment", bg="red", fg="white", font="Helvetica 12 bold",
                                  command=self.computePayment).grid(row=6, column=2, sticky=E)
        btClear = Button(window, text="Clear", bg='blue', fg='white', font="Helvetica 12 bold",
                         command=self.delete_all).grid(row=6, column=8, pady=20, padx=20, sticky=E)
