...
class Application(Frame):
    ...
    def __init__(self,master):
        ...
        self.grid() #to register widgets with grid geometry manager
        self.create_widgets()
